...
<body>
	<div id="wrapper" style="width:600px; margin:0 auto">
		<form:form action="edit_reply.do" modelAttribute="rvo" method="post">	
			<div style="padding:20px 0">
				<h3>답글 수정</h3>
				<hr />
				<div class="form-inline">				
					<input type="hidden" value="${vo.rsv_cmt_no}"/>
					<form:input type="hidden" value="${vo.rep_no}" path="rep_no"/>
				...
				<div class="form-inline" align="center" style="margin-bottom:20px">
					<input type="submit" class="btn btn-success" value="답글 수정"/>
					<a href="delete_reply.do?rep_no=${vo.rep_no}" class="btn btn-danger">답글 삭제</a>
