	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="container" style="margin-top:150px; min-height:600px">
			      ...
			      <form:form action="biz_join.do" id="form" class="form-horizontal" enctype="multipart/form-data" modelAttribute="vo" method="post" >
			                     ...
			                     <div class="col-sm-5">
			                        <div class="buttons">      
			                           <div class="form-inline" style="margin-bottom:5px">
			                                   ...
			                                   <input type="text" class="form-control price"  style="width:40%" name="bbb">
