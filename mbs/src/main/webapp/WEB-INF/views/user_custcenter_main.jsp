...
<div style="margin-top:68px;">
  <div class="container" style="margin:0px auto">
  	...
  	<div class="btn-group" role="group">
		<a href="user_custcenter_notice.do"><button type="button" class="btn btn-default" style="height:200px">
	...
	<div class="btn-group" role="group">
		<a href="user_custcenter_event.do"><button type="button" class="btn btn-default" style="height:200px">
		...
		<h2>이벤트</h2>
			...
			<div class="btn-group" role="group">
		<a href="user_custcenter_question.do"><button type="button" class="btn btn-default" style="height:200px">
		...
		<h2>1:1문의</h2>
			...
			<div class="btn-group" role="group">
		<a href="user_custcenter_faq.do"><button type="button" class="btn btn-default" style="height:200px">
	...
	<div class="row" style="margin-top:20px;border-top:2px solid #cccccc">
		...
		<tr style="border-bottom:1px solid #cccccc; width:40%">
				<th>공지사항</th>
				<th style="width:30px" align="right"><a href="user_custcenter_notice.do">+</a></th>
			</tr>
			<c:forEach begin="1" end="4">
			<tr>
				<td colspan="2">홈페이지 점검 안내</td>
			</tr>
			</c:forEach>
		</table>
		</div>
		...
		<a href="user_custcenter_question.do"><input type="button" class="w3-button w3-black w3-round" value="문의하기"/></a>
		</div>
		</div>
		</div>
	</div>
